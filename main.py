...
parser.add_argument('-im', '--initMovement', type=int, help='The angle where starts the movement for each rotation. || El ángulo donde arranca el movimiento para cada rotación', required=False, default=0)
parser.add_argument('-em', '--endMovement', type=int, help='The angle where ends the movement for each rotation. || El ángulo donde termina el movimiento para cada rotación', required=False, default=0)
parser.add_argument('-csm', '--cantStepMovement', type=int, help='The quantity of movements between angles defined in movement. || La cantidad de movimiento entre los ángulso de movimiento', required=False, default=1)
